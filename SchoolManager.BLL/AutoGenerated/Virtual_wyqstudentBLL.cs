...
namespace SchoolManager.BLL
{
	public class Virtual_wyqstudentBLL
	{
        ...
        public virtual bool Create(ref ValidationErrors errors, wyqstudentModel model)
        {
            try
            {
        ...
        public virtual bool Edit(ref ValidationErrors errors, wyqstudentModel model)
        {
            try
            {
                wyqstudent entity = m_Rep.GetById(model.Sno);
