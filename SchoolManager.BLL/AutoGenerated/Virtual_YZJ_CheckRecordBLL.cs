...
namespace SchoolManager.BLL
{
	public class Virtual_YZJ_CheckRecordBLL
	{
        ...
        public virtual bool Create(ref ValidationErrors errors, YZJ_CheckRecordModel model)
        {
            try
            {
        ...
        public virtual bool Edit(ref ValidationErrors errors, YZJ_CheckRecordModel model)
        {
            try
            {
                YZJ_CheckRecord entity = m_Rep.GetById(model.id);
