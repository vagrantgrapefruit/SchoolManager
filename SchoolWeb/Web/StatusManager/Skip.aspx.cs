...
namespace SchoolWeb.Web.StatusManager
{
    public partial class Skip : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            switch (Request.QueryString["action"])
            {
                case "getStudent":
                    ...
                    break;
                case "Skip":
                    SkipGrade(Request.QueryString["reason"], Request.QueryString["StdRollId"], Request.QueryString["gradeTime"], Request.QueryString["transferClass"]);
                    break;
            }
        }
        /// <summary>
        ...
        public void SkipGrade(string reason, string StdRollId,string gradeTime,string transferClass)
        {
            try
            {
                ...
                model.ApplyType = "跳级;"+ gradeTime + ";"+ transferClass;
