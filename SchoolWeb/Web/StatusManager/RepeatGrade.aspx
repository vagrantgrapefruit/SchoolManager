<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepeatGrade.aspx.cs" Inherits="SchoolWeb.Web.StatusManager.RepeatGrade" %>
...
<head runat="server">
    ...
    <script>
        ...
        function getStudent() {
            //输入学籍号
            $.get("./RepeatGrade.aspx", { "action": "getStudent", "condition": $("#condition").val() }, function (resultString) {
        ...
        function submit() {
            ...
            $.get("./RepeatGrade.aspx", { action: "Repeat", reason: $("#reason").val(), StdRollId: $("#stdrollid").val() }, function (resultString) {
...
<body id="fbody" style="padding:3px;background-color:#F6F4F0;height:100%">
    ...
    <div class="panel panel-default" style="padding: 0px;margin-bottom:1px">
        <div class="panel-heading" style="padding: 3px;padding-left:5px;padding-right:5px">
            <h5><strong>学籍管理 / 学生留级申请</strong></h5>
        </div>
    </div>	 
        ...
        <div class="panel-body" style="padding: 3px;padding-left:5px;padding-right:5px">
            ...
            <form class="form-horizontal" role="form" method="get">
                ...
                <div style="text-align: center;margin:10px">
                    <span id="mes"></span>
                    <a class="btn btn-danger" onclick="submit();">提出申请</a> 
                </div>
