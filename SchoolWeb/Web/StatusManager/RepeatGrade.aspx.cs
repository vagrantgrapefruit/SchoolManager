...
{
    public partial class RepeatGrade : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            switch (Request.QueryString["action"])
            {
                case "getStudent":
                    ...
                    break;
                case "Repeat":
                    Repeat(Request.QueryString["reason"], Request.QueryString["StdRollId"]);
                    break;
            }
        }
        /// <summary>
        ...
        public void Repeat(string reason, string StdRollId)
        {
            try
            {
