<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DropOut.aspx.cs" Inherits="SchoolWeb.Web.StatusManager.DropOut" %>
...
<body id="fbody" style="padding:3px;background-color:#F6F4F0;height:100%">
    <script type="text/javascript">
        ...
        function getStudent() {
            //输入学籍号
            $.get("./DropOut.aspx", { "action": "getStudent", "condition": $("#condition").val() }, function (resultString) {
        ...
        function submit() {
            ...
            $.get("./DropOut.aspx", { "action": "DropOut", "reason": $("#reason").val(), "StdRollId": $("#stdrollid").val() }, function (resultString) {
    ...
    <div class="panel panel-default" style="padding: 0px;margin-bottom:1px">
        <div class="panel-heading" style="padding: 3px;padding-left:5px;padding-right:5px">
            <h5><strong>学籍管理 / 学生退学申请</strong></h5>
        </div>
    </div>	 
